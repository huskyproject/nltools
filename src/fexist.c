/* I copied this file from the smapi source into the nltools directory because
   I did not want to link against the complete smapi library (and dramatically
   increase binary code size with all the Squish and Jam functions) only
   because fidoconfig imports the direxist function from smapi. */
